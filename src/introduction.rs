...
pub fn introduction_frame(frame: &mut Frame) {
    ...
    let introduction = Paragraph::new(Text::styled("Task Manager TUI\nby A. Shaikh", Style::default().bold().fg(ratatui::style::Color::Green)))
        .block(Block::default()
    ...
    let controls = Paragraph::new(Text::styled("Press [enter] to continue", 
        Style::default()
